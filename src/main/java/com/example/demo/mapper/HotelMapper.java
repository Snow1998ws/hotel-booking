...
public interface HotelMapper {
    List<Hotel> selectByDateAndCityAndRates(@Param("city")String city, @Param("low")Integer low, @Param("high")Integer high, @Param("checkin_time")String checkin_time, @Param("leave_time")String leave_time);
    /**
